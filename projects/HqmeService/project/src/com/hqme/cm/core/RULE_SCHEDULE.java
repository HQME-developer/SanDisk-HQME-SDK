...
public class RULE_SCHEDULE extends RuleBase {
    // ==================================================================================================================================
    private static RULE_SCHEDULE sRULE_SCHEDULE_INSTANCE = new RULE_SCHEDULE();
    ...
    // ----------------------------------------------------------------------------------------------------------------------------------
    public static RULE_SCHEDULE getInstance() {
        return sRULE_SCHEDULE_INSTANCE;
    }
