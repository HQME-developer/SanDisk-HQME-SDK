...
public class QueueRequestProperties {
    ...
    public static enum OptionalProperties {
       REQPROP_POLICY, REQPROP_IMMEDIATE, REQPROP_EXPIRATION_DATE, REQPROP_PERMISSIONS_USER, REQPROP_PERMISSIONS_GROUP, REQPROP_PERMISSIONS_WORLD, REQPROP_GROUP, REQPROP_BROADCAST_INTENT
    };
